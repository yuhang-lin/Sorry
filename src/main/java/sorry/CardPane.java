...
public class CardPane extends BorderPane{
	...
	public CardPane(Card c) {
	    ...
	    BorderPane topLabel = new BorderPane();
	    BorderPane bottomLabel = new BorderPane();
	    ...
	    //topLabel.getChildren().addAll(cardText1,cardDesc);
	    //bottomLabel.getChildren().addAll(cardDesc1,cardText2);
