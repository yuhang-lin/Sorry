...
// I am guessing that it should display the top 10 games played by the user.
// First they will be ordered
// by whether the player came in first. Then, they should be ranked by the
// amount of time it took the player to win.
